...
export default async function InstructorEmitCertPage({ params }: Props) {
  ...
  if (enrollment.certificate) {
    return (
      <div className="max-w-xl space-y-4">
        ...
        <Link href="/instructor/students" className="text-blue-600 hover:underline text-sm">
          ← Volver a mis grupos
        </Link>
      </div>
    );
  ...
  return (
    <div className="max-w-3xl space-y-6">
      <div className="flex items-center gap-3">
        <Link href="/instructor/students" className="text-gray-500 hover:text-gray-700">
